...
async def main():
    ...
    parser.add_argument("--voice_type", default="",  help="Voice type")
    ...
    headers = {
        ...
        "X-Api-Resource-Id": (
            args.resource_id if args.resource_id else get_resource_id(voice_type)
        ),
    ...
    try:
        ...
        for i, sentence in enumerate(sentences):
            ...
            if audio_data:
                filename = f"{voice_type}_session_{i}.{args.encoding}"
